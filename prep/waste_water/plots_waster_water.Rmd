...
```{r}
stations <- read_csv("./data/output/water_treatment_stations_per_prodarea.csv")
```
...
plot1 <- ggplot() +
  ...
  geom_sf(
    mapping = aes(fill = waste_stations19),
    data = prodareas_sf,
    color = "grey68",
    size = 0.5
  ) +
...
This is an example from aquaculture production plotting
